...
void COINMETIS_NODEND(int *nvtxs, idxtype *xadj, idxtype *adjncy, int *numflag, int *options, idxtype *perm, idxtype *iperm)
{
...
void coinmetis_nodend_(int *nvtxs, idxtype *xadj, idxtype *adjncy, int *numflag, int *options, idxtype *perm, idxtype *iperm)
{
    metis_nodend_(nvtxs, xadj, adjncy, numflag, options, perm, iperm);
}

void coinmetis_nodend__(int *nvtxs, idxtype *xadj, idxtype *adjncy, int *numflag, int *options, idxtype *perm, idxtype *iperm)
{
...
static void COINMETIS_NodeND(int *nvtxs, idx_t *xadj, idx_t *adjncy, int *numflag, int *options, idx_t *perm, idx_t *iperm)
{
...
void COINMETIS_NODEND(int *nvtxs, idx_t *xadj, idx_t *adjncy, int *numflag, int *options, idx_t *perm, idx_t *iperm)
{
...
void coinmetis_nodend_(int *nvtxs, idx_t *xadj, idx_t *adjncy, int *numflag, int *options, idx_t *perm, idx_t *iperm)
{
    COINMETIS_NodeND(nvtxs, xadj, adjncy, numflag, options, perm, iperm);
}

void coinmetis_nodend__(int *nvtxs, idx_t *xadj, idx_t *adjncy, int *numflag, int *options, idx_t *perm, idx_t *iperm)
{
    COINMETIS_NodeND(nvtxs, xadj, adjncy, numflag, options, perm, iperm);
}
