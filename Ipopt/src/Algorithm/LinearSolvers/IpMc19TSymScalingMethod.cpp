...
void Mc19TSymScalingMethod::SetFunctions(IPOPT_DECL_MC19A(*mc19a))
{
...
bool Mc19TSymScalingMethod::InitializeImpl(const OptionsList & /*options*/, const std::string & /*prefix*/
)
{
    if (user_mc19a != NULL) {
...
bool Mc19TSymScalingMethod::ComputeSymTScalingFactors(Index n, Index nnz, const Index *airn, const Index *ajcn,
                                                      const Number *a, Number *scaling_factors)
{
    DBG_START_METH("Mc19TSymScalingMethod::ComputeSymTScalingFactors", dbg_verbosity);
